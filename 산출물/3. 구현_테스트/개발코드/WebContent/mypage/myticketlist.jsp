...
<body class="myticketlist">
	...
	<section class="container-md text-center" id="content_myticketlist">
		...
		%>
		<a href="../concert/concert_payinfo.jsp?no=<%=info.getOrderNo()%>" class="text-decoration-none text-dark">
						...
						<div class="col-md-10 container p-3">
							<div class="row pb-3">
								<div class="col-md-4">
									<p>
										성명:
										<br><%=info.getFirstName() + " " + info.getLastName()%></p>
								</div>
								<div class="col-md-4">
									<p>
										콘서트일자:
										<br><%=info.getDate().split(" ")[0]%></p>
								</div>
								<div class="col-md-4">
									<p>
										콘서트번호:
										<br><%=info.getConcertNo()%></p>
								</div>
							</div>
							<div class="row pb-3">
								<div class="col-md-4">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<p>
										좌석:
										<br><%=String.join("/", info.getSeats())%></p>
								</div>
							</div>
						</div>
					</div>

...
<body>
	<nav id="header"
		class="navbar navbar-expand-sm navbar-light text-dark sticky-top"
		style="background: tomato; font-family: 'Jua', sans-serif;">
		<!-- Brand -->
		<div style="width: 250px;">
			<a class="navbar-brand mr-auto" href="/concert/index.jsp"> <img
				src="/concert/images/logo.png" height="30">
			</a>
		</div>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav mx-auto">
				<li class="nav-item mx-3" id="concert"><a
					class="nav-link text-nowrap"
					href="/concert/concert/concert_list_date.jsp">스케쥴</a></li>

				<li class="nav-item dropdown mx-3" id="artist"><a
					class="nav-link dropdown-toggle text-nowrap"
					href="/concert/artist/artist_list.jsp" id="navbardrop"
					data-toggle="dropdown"> 아티스트 </a>
					<div class="dropdown-menu" style="top: 80%;">
						<%
							for (ArtistVO vo : list) {
						%>
						<a class="dropdown-item" href="/concert/artist/artist_list.jsp"><%=vo.getName() %></a>
				...
				<li class="nav-item mx-3" id="notice"><a
					class="nav-link text-nowrap" href="/concert/notice/notice_list.jsp">공지사항</a>
				</li>

				<li class="nav-item mx-3" id="mypage"><a
					class="nav-link text-nowrap"
					href="/concert/mypage/myprofile_info.jsp">마이페이지</a></li>

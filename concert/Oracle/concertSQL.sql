...
CREATE TABLE SEATS(
    ...
    SEAT_CLASS VARCHAR2(1) CONSTRAINT NN_SEATS_SEAT_CLASS NOT NULL, -- 좌석 등급
    CONSTRAINT FK_SEATS_CONCERTS FOREIGN KEY (CONCERT_NO) REFERENCES CONCERTS(NO),
    CONSTRAINT FK_SEATS_CNO_SCLASS FOREIGN KEY (CONCERT_NO, SEAT_CLASS) REFERENCES SEAT_PRICE(CONCERT_NO, SEAT_CLASS),

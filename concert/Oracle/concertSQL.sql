...
DROP TABLE CHECKCOMMENT CASCADE CONSTRAINTS;
DROP TABLE CHECKREPORT CASCADE CONSTRAINTS;
...
CREATE TABLE ARTISTS(
    NO NUMBER(10) CONSTRAINT  NN_ARTISTS_NO NOT NULL CONSTRAINT U_ARTISTS_NO UNIQUE, -- 아티스트 번호
...
--댓글 추천 중복방지 테이블
CREATE TABLE CHECKCOMMENT(
    NO NUMBER(10) , -- 댓글 번호
    USERID VARCHAR2(30) , -- 추천 누른 유저 ID
    USERIP VARCHAR(100), -- 해당 유저 IP
    CONSTRAINT PK_CHECKCOMMENT_NO_USERID PRIMARY KEY(NO, USERID),
    CONSTRAINT FK_CHECKCOMMENT_COMMENTS FOREIGN KEY (NO) REFERENCES COMMENTS(NO) ON DELETE CASCADE,
    CONSTRAINT FK_CHECKCOMMENT_MEMBERS FOREIGN KEY (USERID) REFERENCES MEMBERS(ID) ON DELETE CASCADE
);

--댓글 중복신고 방지 테이블
CREATE TABLE CHECKREPORT(
    NO NUMBER(10), -- 댓글 번호
    USERID VARCHAR2(30), -- 신고 누른 유저 ID
    USERIP VARCHAR(100), -- 해당 유저 IP
    CONSTRAINT PK_CHECKREPORT_NO_USERID PRIMARY KEY(NO, USERID),
    CONSTRAINT FK_CHECKREPORT_COMMENTS FOREIGN KEY (NO) REFERENCES COMMENTS(NO) ON DELETE CASCADE,
    CONSTRAINT FK_CHECKREPORT_MEMBERS FOREIGN KEY (USERID) REFERENCES MEMBERS(ID) ON DELETE CASCADE
);
...
CREATE TABLE NOTICES(
    ...
    WRITER VARCHAR2(30) CONSTRAINT NN_NOTICES_WRITER NOT NULL, -- 작성자 ID
    VIEWS NUMBER(10) CONSTRAINT NN_NOTICES_VIEWS NOT NULL, -- 조회수
    TAG VARCHAR2(50), -- 관련 태그
    IMG VARCHAR2(100), -- 사용자가 보게될 파일 명
    SIMG  VARCHAR2(100),  -- 실제로 저장될 파일 명
    CONSTRAINT FK_NOTICES_MEMBERS FOREIGN KEY (WRITER) REFERENCES MEMBERS(ID) ON DELETE CASCADE
);

CREATE TABLE ORDERS(
    NO NUMBER(10) CONSTRAINT PK_ORDERS_NO PRIMARY KEY, -- 주문번호
    ID VARCHAR2(30) CONSTRAINT NN_ORDERS_ID NOT NULL, -- 주문한 ID
...
CREATE TABLE SEATS(
    ...
    ID VARCHAR2(30) CONSTRAINT NN_SEATS_ID NOT NULL, -- 예매한 유저 ID
...
-- 콘서트 등록하기
--72개
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '콘서트여행', '장범준의 월드에 오신걸 환영합니다', '2021-06-21', '서울', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '콘서트여행', '잔나비의 월드에 오신걸 환영합니다', '2021-06-20', '부산', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '콘서트여행', 'IU의 월드에 오신걸 환영합니다', '2021-06-22', '인천', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '콘서트여행', '현아의 월드에 오신걸 환영합니다', '2021-06-19', '대전', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '콘서트여행', '10cm의 월드에 오신걸 환영합니다', '2021-06-18', '대구', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '신년콘서트', '장범준 신년맞이 콘서트', '2021-01-02', '서울', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '신년콘서트', '잔나비 신년맞이 콘서트', '2021-01-02', '서울', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '신년콘서트', 'IU 신년맞이 콘서트', '2021-01-02', '서울', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '신년콘서트', '현아 신년맞이 콘서트', '2021-01-02', '서울', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '신년콘서트', '10cm 신년맞이 콘서트', '2021-01-02', '서울', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '추석콘서트', '장범준 추석 합동 콘서트', '2021-09-20', '부산', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '추석콘서트', '잔나비 추석 합동 콘서트', '2021-09-20', '부산', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '추석콘서트', 'IU 추석 합동 콘서트', '2021-09-20', '부산', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '추석콘서트', '현아 추석 합동 콘서트', '2021-09-20', '부산', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '추석콘서트', '10cm 추석 합동 콘서트', '2021-09-20', '부산', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준','2020크리스마스콘서트',  '2020 장범준 크리스마스 콘서트', '2020-12-25', '서울', 250000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2020크리스마스콘서트', '2020 잔나비 크리스마스 콘서트', '2020-12-25', '부산', 250000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2020크리스마스콘서트', '2020 IU 크리스마스 콘서트', '2020-12-25', '대전', 250000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '2020크리스마스콘서트', '2020 현아 크리스마스 콘서트', '2020-12-25', '광주', 250000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2020크리스마스콘서트', '2020 10cm 크리스마스 콘서트', '2020-12-25', '천안', 250000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '2020 장범준 연말콘서트', '2020 장범준 연말 콘서트로 초대합니다 ', '2020-12-04', '서울', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2020 잔나비 연말 콘서트', '2020 잔나비 연말 콘서트로 초대합니다', '2020-12-05', '부산', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2020 IU 연말 콘서트', '2020 IU 연말 콘서트로 초대합니다', '2020-12-06', '인천', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '2020 현아 연말 콘서트', '2020 현아 연말 콘서트로 초대합니다', '2020-12-07', '대전', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2020 10cm 연말 콘서트', '2020 10cm 연말 콘서트로 초대합니다', '2020-12-08', '대구', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '2021방구석 콘서트', '2021 코시국 방구석 콘서트', '2021-08-20', '공통', 0);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 전국투어', '2021 잔나비 전국 투어 콘서트 [THE DAY]', '2021-08-06', '부산', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 전국투어', '2021 잔나비 전국 투어 콘서트 [THE DAY]', '2021-08-08', '대구', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 전국투어', '2021 잔나비 전국 투어 콘서트 [THE DAY]', '2021-08-10', '광주', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 전국투어', '2021 잔나비 전국 투어 콘서트 [THE DAY]', '2021-08-12', '천안', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 전국투어', '2021 잔나비 전국 투어 콘서트 [THE DAY]', '2021-08-14', '세종', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 전국투어', '2021 잔나비 전국 투어 콘서트 [THE DAY]', '2021-08-16', '서울', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 전국 투어', '2021 아이유 콘서트 투어[LOVE,POEM]', '2021-09-07', '서울', 300000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 전국 투어', '2021 아이유 콘서트 투어[LOVE,POEM]', '2021-09-10', '대전', 300000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 전국 투어', '2021 아이유 콘서트 투어[LOVE,POEM]', '2021-09-12', '대구', 300000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 전국 투어', '2021 아이유 콘서트 투어[LOVE,POEM]', '2021-09-15', '부산', 300000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 전국 투어', '2021 아이유 콘서트 투어[LOVE,POEM]', '2021-09-18', '광주', 300000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2021 십센치 X 겨울', '2021 십센치 X 사계절 콘서트[겨울]', '2021-12-18', '서울', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2021 십센치 X 봄', '2021 십센치 X 사계절 콘서트[봄]', '2021-03-18', '서울', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2021 십센치 X 여름', '2021 십센치 X 사계절 콘서트[여름]', '2021-08-18', '서울', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2021 십센치 X 가을', '2021 십센치 X 사계절 콘서트[가을]', '2021-10-12', '서울', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '2021장범준 멜론 합동 콘서트', '2021 장범준 X 멜론 합동 콘서트', '2021-09-20', '서울', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '2021 현아 빼빼로데이 콘서트', '2021 현아 빼빼로데이 콘서트[롯데]', '2021-11-11', '부산', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '2021 장범준 콘서트월드', '장범준의 월드에 오신걸 환영합니다', '2021-06-01', '서울', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 콘서트월드', '잔나비의 월드에 오신걸 환영합니다', '2021-07-02', '부산', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 콘서트월드', 'IU의 월드에 오신걸 환영합니다', '2021-06-03', '인천', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '2021 현아 콘서트월드', '현아의 월드에 오신걸 환영합니다', '2021-06-04', '대전', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2021 10cm 콘서트월드', '10cm의 월드에 오신걸 환영합니다', '2021-08-05', '대구', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '2021 장범준 서울 콘서트', '장범준[흔들리는 꽃들 속에서]', '2021-02-01', '서울', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '2021 장범준 서울 노래방에서', '장범준[노래방에서 콘서트]', '2021-02-10', '부산', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 리얼판타지', 'IU Real Concert[in seoul]', '2021-03-03', '서울', 300000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU chat-shire', 'IU chat-shire 콘서트', '2021-08-03', '서울', 300000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '2021 현아 기업은행 콘서트', '2021 HyunA 콘서트[기업은행]', '2021-04-04', '서울', 200000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2021 10cm 1234콘서트', '10cm 1234콘서트 [월드컵 경기장]', '2021-08-05', '서울', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '2021 장범준 피크닉콘서트', '장범준x아이유 피크닉콘서트[서울]', '2021-02-10', '서울', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 피크닉콘서트', '잔나비x현아 피크닉콘서트[부산]', '2021-02-11', '부산', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 피크닉콘서트', '장범준x아이유 피크닉콘서트[서울]', '2021-02-10', '서울', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '2021 현아 피크닉콘서트', '잔나비x현아 피크닉콘서트[부산]', '2021-02-11', '부산', 100000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '2021 장범준 음악노을', '음악노을 콘서트[현대카드]', '2021-04-11', '서울', 250000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 음악노을', '음악노을 콘서트[현대카드]', '2021-04-11', '서울', 250000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 음악노을', '음악노을 콘서트[현대카드]', '2021-04-11', '서울', 250000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '2021 현아 음악노을', '음악노을 콘서트[현대카드]', '2021-04-11', '서울', 250000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2021 10cm 음악노을', '음악노을 콘서트[현대카드]', '2021-04-11', '서울', 250000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '2021 장범준 썸머아쿠스틱콘서트', '삼정 더 파크 콘서트', '2021-05-11', '서울', 170000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 썸머아쿠스틱콘서트', '삼정 더 파크 콘서트', '2021-05-11', '서울', 170000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 썸머아쿠스틱콘서트', '삼정 더 파크 콘서트', '2021-05-11', '서울', 170000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '2021 현아 썸머아쿠스틱콘서트', '삼정 더 파크 콘서트', '2021-05-11', '서울', 170000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2021 10cm 썸머아쿠스틱콘서트', '삼정 더 파크 콘서트', '2021-05-11', '서울', 170000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '장범준', '2021 장범준 평화이음 불감자 콘서트', '평화이음 불감자 콘서트[현대카드]', '2021-05-28', '부산', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '잔나비', '2021 잔나비 평화이음 불감자 콘서트', '평화이음 불감자 콘서트[현대카드]', '2021-05-28', '부산', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, 'IU', '2021 IU 평화이음 불감자 콘서트', '평화이음 불감자 콘서트[현대카드]', '2021-05-28', '부산', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '현아', '2021 현아 평화이음 불감자 콘서트', '평화이음 불감자 콘서트[현대카드]', '2021-05-28', '부산', 150000);
INSERT INTO CONCERTS(NO, ARTIST, TITLE, CONTENT, CDATE, LOCATION, PRICE) VALUES(CONCERTS_NO_SEQ.NEXTVAL, '10cm', '2021 10cm 평화이음 불감자 콘서트', '평화이음 불감자 콘서트[현대카드]', '2021-05-28', '부산', 150000);
...
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'test', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'test', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'test', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'test', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'test', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'qqqqq', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'qqqqq', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'qqqqq', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'qqqqq', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'qqqqq', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'asdasd', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'asdasd', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'asdasd', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'asdasd', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'asdasd', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'zxc', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'zxc', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'zxc', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'zxc', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'zxc', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'aaa', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'aaa', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'aaa', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'aaa', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'aaa', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'abc123', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'abc123', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'abc123', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'abc123', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'abc123', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'dlckdals', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'dlckdals', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'dlckdals', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'dlckdals', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'dlckdals', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rkdwlstmf', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rkdwlstmf', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rkdwlstmf', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rkdwlstmf', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rkdwlstmf', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'ghdwnstn', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'ghdwnstn', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'ghdwnstn', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'ghdwnstn', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'ghdwnstn', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'wnehdtjd', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'wnehdtjd', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'wnehdtjd', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'wnehdtjd', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'wnehdtjd', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rnwldnjs', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rnwldnjs', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rnwldnjs', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rnwldnjs', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rnwldnjs', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'wkawkfl32', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'wkawkfl32', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'wkawkfl32', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'wkawkfl32', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'wkawkfl32', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rkddnjsehcorh', 68);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rkddnjsehcorh', 69);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rkddnjsehcorh', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rkddnjsehcorh', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'rkddnjsehcorh', 72);

INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'nic', 70);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'nic', 71);
INSERT INTO ORDERS VALUES(ORDERS_NO_SEQ.NEXTVAL, 'nic', 72);
...
-- 좌석 하나 예매하기
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(2, 'A_1', 'hwisaek', 2);
...
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'A_7', 'test', 3);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'A_7', 'test', 4);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'A_7', 'test', 5);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'A_7', 'test', 6);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'A_7', 'test', 7);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'A_8', 'qqqqq', 8);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'A_8', 'qqqqq', 9);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'A_8', 'qqqqq', 10);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'A_8', 'qqqqq', 11);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'A_8', 'qqqqq', 12);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'A_9', 'asdasd', 13);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'A_9', 'asdasd', 14);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'A_9', 'asdasd', 15);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'A_9', 'asdasd', 16);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'A_9', 'asdasd', 17);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'A_10', 'zxc', 18);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'A_10', 'zxc', 19);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'A_10', 'zxc', 20);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'A_10', 'zxc', 21);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'A_10', 'zxc', 22);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'A_11', 'aaa', 23);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'A_11', 'aaa', 24);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'A_11', 'aaa', 25);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'A_11', 'aaa', 26);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'A_11', 'aaa', 27);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'A_12', 'abc123', 28);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'A_12', 'abc123', 29);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'A_12', 'abc123', 30);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'A_12', 'abc123', 31);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'A_12', 'abc123', 32);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'B_8', 'dlckdals', 33);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'B_8', 'dlckdals', 34);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'B_8', 'dlckdals', 35);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'B_8', 'dlckdals', 36);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'B_8', 'dlckdals', 37);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'B_9', 'rkdwlstmf', 38);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'B_9', 'rkdwlstmf', 39);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'B_9', 'rkdwlstmf', 40);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'B_9', 'rkdwlstmf', 41);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'B_9', 'rkdwlstmf', 42);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'B_10', 'ghdwnstn', 43);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'B_10', 'ghdwnstn', 44);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'B_10', 'ghdwnstn', 45);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'B_10', 'ghdwnstn', 46);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'B_10', 'ghdwnstn', 47);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'B_11', 'wnehdtjd', 48);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'B_11', 'wnehdtjd', 49);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'B_11', 'wnehdtjd', 50);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'B_11', 'wnehdtjd', 51);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'B_11', 'wnehdtjd', 52);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'B_12', 'rnwldnjs', 53);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'B_12', 'rnwldnjs', 54);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'B_12', 'rnwldnjs', 55);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'B_12', 'rnwldnjs', 56);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'B_12', 'rnwldnjs', 57);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'C_11', 'wkawkfl32', 58);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'C_11', 'wkawkfl32', 59);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'C_11', 'wkawkfl32', 60);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'C_11', 'wkawkfl32', 61);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'C_11', 'wkawkfl32', 62);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(68, 'C_12', 'rkddnjsehcorh', 63);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(69, 'C_12', 'rkddnjsehcorh', 64);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'C_12', 'rkddnjsehcorh', 65);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'C_12', 'rkddnjsehcorh', 66);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'C_12', 'rkddnjsehcorh', 67);

INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(70, 'C_13', 'nic', 68);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(71, 'C_14', 'nic', 69);
INSERT INTO SEATS(CONCERT_NO, SEAT_NO, ID, ORDER_NO) VALUES(72, 'C_15', 'nic', 70);

-- 한번에 여러 좌석 예매하기 
INSERT INTO SEATS
    SELECT 72, 'B_1', 'test', 2 FROM DUAL UNION ALL 
    SELECT 72, 'B_2', 'test', 2 FROM DUAL UNION ALL 
    SELECT 72, 'B_3', 'test', 2 FROM DUAL UNION ALL 
    SELECT 72, 'B_4', 'test', 2 FROM DUAL; 

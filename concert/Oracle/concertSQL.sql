...
(
    NO NUMBER(30) CONSTRAINT PK_MEMBERS_NO NOT NULL UNIQUE, -- 회원 번호
    ID VARCHAR2(30) CONSTRAINT PK_MEMBERS_ID PRIMARY KEY, -- 아이디
    PW VARCHAR2(30) CONSTRAINT NN_MEMBERS_PW NOT NULL, -- 패스워드

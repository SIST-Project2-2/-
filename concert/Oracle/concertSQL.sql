...
-- 댓글 출력
SELECT ARTIST,ID,CONTENT,TO_CHAR(RDATE, 'YYYY/MM/DD') FROM (SELECT * FROM REPLY ORDER BY RDATE DESC);
...
-- 프로필 보기 - 최근 예매날짜 포함
SELECT NO, ID, NICKNAME, FIRST_NAME, LAST_NAME, BIRTHDATE, SEX, ADDRESS, PHONE, EMAIL, CDATE
FROM (SELECT NO,ID,NICKNAME,FIRST_NAME, LAST_NAME,TO_CHAR(BIRTHDATE, 'YYYY-MM-DD') AS BIRTHDATE,SEX,ADDRESS,PHONE,EMAIL 
          FROM MEMBERS 
          WHERE ID='admin') A
          LEFT OUTER JOIN

...
$(document).ready(function() {
	...
	$(".admin_artist_comment #category_id").click(function() {
		$(".admin_artist_comment #category_dropdown").html("ID");
		$(".admin_artist_comment #category").val("id");
	})
	$(".admin_artist_comment #category_content").click(function() {
		$(".admin_artist_comment #category_dropdown").html("내용");
		$(".admin_artist_comment #category").val("content");
	})
	...
	$('.admin_artist_comment #deleteModal').on('show.bs.modal', function(event) {
		...
		modal.find('.admin_artist_comment #btn_ok').click(function() {
			$.ajax({
				type: "get",

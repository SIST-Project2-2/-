			...
			<thead>
				<tr>
					<th class="text-left">
						...
						<h2 class="text-weight-bold"><%=vo.getTitle()%></h2> <small
						class="text-dark font-weight-bold"><%=vo.getDate()%></small> <small
						class="text-dark font-weight-bold"><%="조회수: " + vo.getViews()%></small>
					</th>
				</tr>
			</thead>
			<!-- 내용 -->
